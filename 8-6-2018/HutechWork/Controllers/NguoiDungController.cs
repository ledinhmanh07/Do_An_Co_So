                ...
                if (tk1 == null)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            tt.MATKCN = db.TAIKHOAN_CNs.SingleOrDefault(a => a.ID == tendn && a.PASS == matkhau).MATKCN;
                            db.THONGTINCANHANs.InsertOnSubmit(tt);
                            db.SubmitChanges();
                            HOSOXINVIEC hs = new HOSOXINVIEC();
                            hs.MATKCN = tt.MATKCN;
                            db.HOSOXINVIECs.InsertOnSubmit(hs);
                            db.SubmitChanges();
