...
namespace HutechWork.Controllers
{
    public class NguoiDungController : Controller
    {
        ...
        public ActionResult DangKy(FormCollection form,TAIKHOAN_CN tk)
        {
            ...
            {
                TAIKHOAN_CN tk1 = db.TAIKHOAN_CNs.SingleOrDefault(n => n.ID == tendn);
                if (tk1 == null)
                {
                    if (Kiemtramatkhau(matkhau) == false)
        ...
        public ActionResult Landaudangnhap()
        {
            return View();
        }
        [HttpPost]
        ...
        [HttpGet]
        public ActionResult Landaudangnhap2()
        {        
            return View();
        }
        [HttpPost]
        public ActionResult Landaudangnhap2(FormCollection fr)
        {
            ...
            HOSOXINVIEC tk1=new HOSOXINVIEC();
            tk1.MATKCN = Convert.ToInt32(Session["TaikhoanCN"]);
            tk1.MANGANH = Convert.ToInt32(nganhnghe);
            tk1.HOCVAN = hocvan;
            tk1.KINHNGHIEM = kinhnghiem;
            tk1.KYNANG = kynang;
            tk1.NGOAINGU = ngoaingu;
            tk1.LUONGMM = luongmm;
            db.HOSOXINVIECs.InsertOnSubmit(tk1);
            db.SubmitChanges();
